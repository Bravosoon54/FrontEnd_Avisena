    ...
    <tr data-id="${catId}">
      <td class="px-0">
        <div class="d-flex align-items-center">
          <div class="ms-3">
            <h6 class="mb-0 fw-bolder">${cat.nombre}</h6>
          </div>
        </div>
      </td>
      ...
      <td class="px-0">
        <div class="d-flex gap-2">
          <button class="btn btn-sm btn-warning" data-action="edit" data-id="${catId}">Editar</button>
          <button class="btn btn-sm btn-danger" data-action="delete" data-id="${catId}">Eliminar</button>
        </div>
      </td>
    </tr>
  `;
